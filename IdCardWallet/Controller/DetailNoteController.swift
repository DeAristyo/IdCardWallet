...
class DetailNoteController: UIViewController {
    let noteField = [
        ...
        Form(title: "Note", value: "He got that James Dean daydream look in his eyes")
    ]
    ...
    override func viewDidLoad() {
        ...
        let actionEditNote = UIAction(title: "Edit Note", image: UIImage(named: "editProfileImage")) { _ in
            let noteSheet = AddNoteSheet(title: "Edit Note")
            let navigationViewController = UINavigationController(rootViewController: noteSheet)
